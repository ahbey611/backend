...
class SeleniumTestCase(LiveServerTestCase):
    ...
    def test_web(self):
        ...
        """
        self.webclient.find_element_by_xpath(
            "//*[@id='root']/div/div[3]/div/div/div/a").click()
        time.sleep(1)
        self.webclient.find_element_by_xpath(
        ...
        """
        self.webclient.find_element_by_xpath(
            "//*[@id='post-main']/div[2]/span[2]/span/a[1]/span[1]").click()
        time.sleep(1)
        # https://stackoverflow.com/a/25292668/22234829
        # 先全选再发送文字，解决无法clear问题
        self.webclient.find_element_by_xpath(
            "//*[@id='root']/div/div[3]/div/div/div[1]/div/input").send_keys((Keys.CONTROL, "a"))
        self.webclient.find_element_by_xpath(
            "//*[@id='root']/div/div[3]/div/div/div[1]/div/input").send_keys("Hello World!")
        time.sleep(1)
        self.webclient.find_element_by_xpath(
        ...
        """
        self.webclient.find_element_by_xpath(
            "//*[@id='post-main']/div[2]/span[2]/span/a[2]/span[1]").click()
        time.sleep(1)
        self.webclient.find_element_by_xpath(
            "//*[@id='root']/div/div[3]/div/div/div[2]/div[2]/section[1]/textarea").send_keys("你好！")
        time.sleep(1)
        ...
        """
        self.webclient.find_element_by_xpath(
            "//*[@id='root']/div/header/div/span/a/span[1]").click()
        time.sleep(1)
        self.webclient.find_element_by_xpath(
